...
import { Text, Heading, Link, Image } from 'dfswap-ui'
  ...
  return (
    <LayoutWrapper>
      ...
      <Text fontSize="16px">
        {TranslateString(
          999,
          'Spend DF to buy tickets, contributing to the lottery pot. Win prizes if 2, 3, or 4 of your ticket numbers match the winning numbers and their exact order!',
        )}
      </Text>
