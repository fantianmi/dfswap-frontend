...
import { Heading, Card, CardBody, CardFooter, Text, PancakeRoundIcon, Flex, Skeleton,Image } from 'dfswap-ui'
    ...
    <Card>
      <CardBody>
        ...
        <CardHeading>
          <Left>
            <IconWrapper>
              <CardImage src="/images/egg/logo.png" alt="lottery bunny" width={64} height={64} />
            </IconWrapper>
            <PrizeCountWrapper>
              <Text fontSize="14px" color="textSubtle">
                {TranslateString(999, 'Total Pot:')}
              </Text>
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} DF</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
